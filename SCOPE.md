...
### Out of Scope
- Group creation or membership management.
- Expense creation, splitting, and calculation engines.
- Settlement creation or balance mutation.
- CSV import data writes.
- Additional CRUD API routes or Server Actions outside user preferences.
